    ...
    jQuery(function($) {
        ...
        jQuery(grid_selector).jqGrid({
            ...
            colModel:[
                ...
                {name:'uid',index:'uid',width:60, sorttype:"int",editable : false,editoptions : {readonly : true,size : 10}},
                {name:'uname',index:'uname', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}}
            ],
            viewrecords : true,
            rowNum:10,
            rowList:[10,20,30],
            ...
            editurl: "/user/dummy.action",//nothing is saved
            caption: "用户表" ,
            jsonReader: {
                repeatitems : false,
                id: "uid"
